          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Expanded(child: StatCard(Icons.auto_stories, 'مجموعات منطلقة',
                  '${kGroups.where((g) => g.status == "running").length} / ${kGroups.length}', color: AppTheme.purple)),
            ...
            Row(children: [
              ...
              Expanded(child: StatCard(Icons.calendar_month, 'جلسات اليوم', '${kSessions.length}', color: AppTheme.purple)),
              Expanded(child: StatCard(Icons.inventory_2, 'أصناف تحت الحد', '${kInventory.where((i) => i.low).length}', color: AppTheme.gold)),
            ]),
