  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final currentGroups = kGroups.where((g) => g.status == 'running').length;
        final totalGroups = kGroups.length;
        ...
        return SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Expanded(child: StatCard(Icons.auto_stories, 'مجموعات جارية',
                  '$currentGroups / $totalGroups', color: AppTheme.purple)),
