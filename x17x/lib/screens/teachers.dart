  ...
  Future<void> _resetDatabase() async {
    final ok = await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
              'سيتم حذف كل البيانات المحلية نهائيًا من قاعدة التسجيل: الطلاب، المواد، المدرسون، الدورات، الطلبات، والانتظار، مع تفريغ البيانات التشغيلية والمالية والمحاسبية الحالية للتجربة. هذا الزر مؤقت للتجربة. هل تريد المتابعة؟',
            ),
            actions: [
